...
leaflet(upcoming_event, options =
          leafletOptions(minZoom = 2,maxZoom = 6,
  ...
  addGraticule(style = list(color = "#fff", weight = 1.5, opacity = 1)) %>%
  addGraticule(sphere = TRUE, style = list(color = "#fff", weight = 1, opacity = 0.25)) %>%
  addPolygons(data = spdf, weight = 1.2, color = "#2165b6")  %>% 
  addMarkers(popup = ~paste0('<a href =',link,'>', name, '</a><br> Created: ', created, '<br>',
