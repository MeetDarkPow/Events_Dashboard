...
<a class="navlink" href="#topics" data-toggle="tab" aria-expanded="true"><i class="fa fa-edit"></i> Location Map</a>
</div>
...
```{r}
valueBox(length(satrday_city$City), icon = "fa-city", color = "darkblue")
```
